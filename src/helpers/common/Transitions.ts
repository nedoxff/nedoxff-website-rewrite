...
export function animateClipTransition<T extends HTMLElement>(params: ClipTransitionParams, ref: RefObject<T>) {
    const a = params.axis;
    ...
    gsap.set(ref.current, { clipPath: b ? end : start, display: params.display ?? 'block' });
